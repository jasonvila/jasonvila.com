    ...
    getBlog() {
        this.allServicesService.getBlog(this.id).subscribe(blog => {
            ...
            for (let e of this.data) {
                var date = e.date;
                div.innerHTML = "<h3>" + e.title + "</h3><h4 class='blog-entry-category blog-entry-element'>" + date.substring(4, 6) + "/" + date.substring(6, 8) + "/" + date.substring(0, 4) + "</h4><h4>" + e.category + "</h4><p>" + e.content + "<br/><br/></br></p>";
            }
            this.loading = false;
